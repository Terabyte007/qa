myApp.controller("adminsectionCtrl", function($scope, $http, $timeout, $routeParams, $rootScope){
	$scope.entryLimit = 5; //max no of items to display in a page
	$rootScope.logout = true;
	$rootScope.login = false;

	 $http.post('backend/fetch.php?what=applicants').success(function(response){
